...
const Footer = () => {
  ...
  return (
    <footer
      id="contact"
      className="bg-brand-dark text-white pt-16 md:pt-24 pb-8 md:pb-12 px-4 md:px-6"
    >
      <div className="max-w-7xl mx-auto min-w-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 mb-12 md:mb-20">
          ...
          <div className="space-y-8 md:space-y-12 min-w-0">
            ...
            <div>
              ...
              <p className="text-gray-400 text-base md:text-lg max-w-md">
                Ready to start your next project? Get in touch with us for a
            ...
            <div className="space-y-5 md:space-y-6">
              ...
              <div className="flex items-center gap-4 group min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=61555891768823"
                    target="_blank"
          ...
          {/* Contact Form */}
          <div className="bg-white p-6 sm:p-8 md:p-12 rounded-3xl shadow-2xl min-w-0 overflow-visible">
            <form
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
                ...
                <div className="space-y-1.5 md:space-y-2 min-w-0">
                  <label className="text-[10px] md:text-sm font-bold text-brand-dark uppercase tracking-wider">
                    Name
                  </label>
                  ...
                  <input
                    ...
                    className="w-full min-w-0 bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-sm md:text-base text-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-teal transition-all"
                  />
                </div>
              ...
              <div className="space-y-1.5 md:space-y-2">
                ...
                <textarea
                  ...
                  className="w-full min-w-0 bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 text-sm md:text-base text-brand-dark focus:outline-none focus:ring-2 focus:ring-brand-teal transition-all resize-none"
                />
              </div>

              {/* Cloudflare Turnstile */}
              <div className="w-full min-w-0 overflow-visible">
                <div className="w-full max-w-full overflow-visible flex justify-center sm:justify-start">
                  <Turnstile
                    siteKey={
              ...
              {/* Success Message */}
              {status === "success" && (
                <div className="flex items-center gap-2 text-green-600 font-medium justify-center animate-in fade-in slide-in-from-top-1 text-sm">
                  <CheckCircle size={20} />
              ...
              {/* Error Message */}
              {status === "error" && (
                <div className="flex items-center gap-2 text-red-600 font-medium justify-center animate-in fade-in slide-in-from-top-1 text-sm text-center">
